...
if("TRUE" STREQUAL "TRUE")
  set(pepper_sensors_py_SOURCE_PREFIX /home/mivia/ProjectWorkspace/src/pepper_robot/pepper_sensors_py)
  set(pepper_sensors_py_DEVEL_PREFIX /home/mivia/ProjectWorkspace/devel/.private/pepper_sensors_py)
  ...
  set(pepper_sensors_py_INSTALL_PREFIX /home/mivia/ProjectWorkspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pepper_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mivia/ProjectWorkspace/src/pepper_robot/pepper_sensors_py/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mivia/ProjectWorkspace/devel/.private/pepper_sensors_py/lib;/home/mivia/ProjectWorkspace/devel/lib;/opt/ros/melodic/lib)
