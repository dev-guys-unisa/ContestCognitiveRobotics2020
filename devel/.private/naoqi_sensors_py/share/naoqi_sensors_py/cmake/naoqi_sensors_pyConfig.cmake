...
if("TRUE" STREQUAL "TRUE")
  set(naoqi_sensors_py_SOURCE_PREFIX /home/mivia/ProjectWorkspace/src/naoqi_bridge/naoqi_sensors_py)
  set(naoqi_sensors_py_DEVEL_PREFIX /home/mivia/ProjectWorkspace/devel/.private/naoqi_sensors_py)
  ...
  set(naoqi_sensors_py_INSTALL_PREFIX /home/mivia/ProjectWorkspace/install)
...
if(NOT "/home/mivia/ProjectWorkspace/devel/.private/naoqi_sensors_py/include " STREQUAL " ")
  set(naoqi_sensors_py_INCLUDE_DIRS "")
  set(_include_dirs "/home/mivia/ProjectWorkspace/devel/.private/naoqi_sensors_py/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mivia/ProjectWorkspace/src/naoqi_bridge/naoqi_sensors_py/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mivia/ProjectWorkspace/devel/.private/naoqi_sensors_py/lib;/home/mivia/ProjectWorkspace/devel/lib;/opt/ros/melodic/lib)
