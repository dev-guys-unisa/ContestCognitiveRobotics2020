...
if("TRUE" STREQUAL "TRUE")
  set(naoqi_bridge_msgs_SOURCE_PREFIX /home/mivia/ProjectWorkspace/src/naoqi_bridge_msgs)
  set(naoqi_bridge_msgs_DEVEL_PREFIX /home/mivia/ProjectWorkspace/devel/.private/naoqi_bridge_msgs)
  ...
  set(naoqi_bridge_msgs_INSTALL_PREFIX /home/mivia/ProjectWorkspace/install)
...
if(NOT "/home/mivia/ProjectWorkspace/devel/.private/naoqi_bridge_msgs/include " STREQUAL " ")
  set(naoqi_bridge_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/mivia/ProjectWorkspace/devel/.private/naoqi_bridge_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_bridge_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mivia/ProjectWorkspace/src/naoqi_bridge_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mivia/ProjectWorkspace/devel/.private/naoqi_bridge_msgs/lib;/home/mivia/ProjectWorkspace/devel/lib;/opt/ros/melodic/lib)
