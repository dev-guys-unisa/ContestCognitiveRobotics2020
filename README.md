...
This task is made relying on the [ROS (Robot Operating System)](https://wiki.ros.org) library, in particular the *melodic* distro. Moreover you need the following Python packages, which can be installed through the following command *pip install 'package_name'*:
```
tensorflow=2.2
pattern=3.6
opencv=4.4.0
